...
window.__view_insights = {
  data() {
    return {
      ...
      cards: [
        {
          id: 1, part: 'PART 1', icon: 'bi-bar-chart-line', chapter: '1장',
        ...
        {
          id: 2, part: 'PART 1', icon: 'bi-coin', chapter: 'PART 1 도입',
        ...
        {
          id: 3, part: 'PART 1', icon: 'bi-heartbreak',
          chapter: '2장',
        ...
        {
          id: 4, part: 'PART 1', icon: 'bi-trophy', chapter: '1장',
        ...
        {
          id: 5, part: 'PART 2', icon: 'bi-cash-stack', chapter: '4장 · 14장',
        ...
        {
          id: 6, part: 'PART 2', icon: 'bi-bullseye', chapter: '7장',
        ...
        {
          id: 7, part: 'PART 2', icon: 'bi-arrow-repeat', chapter: '9장',
        ...
        {
          id: 8, part: 'PART 3', icon: 'bi-alarm', chapter: '13장',
        ...
        {
          id: 9, part: 'PART 3', icon: 'bi-graph-up-arrow', chapter: '17장',
          title: '20년을 버틴 결과',
        ...
        {
          id: 10, part: 'PART 3', icon: 'bi-sliders', chapter: '11장',
        ...
        {
          id: 11, part: 'PART 4', icon: 'bi-bank', chapter: '15장',
        ...
        {
          id: 12, part: 'PART 4', icon: 'bi-search', chapter: 'PART 4 도입',
        ...
        {
          id: 13, part: 'PART 4', icon: 'bi-calendar-check', chapter: '18장',
        ...
        {
          id: 14, part: 'PART 5', icon: 'bi-megaphone', chapter: '19장',
        ...
        {
          id: 15, part: 'PART 5', icon: 'bi-flag', chapter: '21장',
          title: '끝까지 남는 것이 승리다',
