...
| P-040 | 서비스 이용 매뉴얼 작성 (책자 삽입용) | [x] | 2026-04-06 | 2026-04-06 | Puppeteer 14장 캡처, 8섹션 매뉴얼, Word 변환 |
| P-041 | OG 이미지 + 웹앱 아이콘 + PWA manifest | [x] | 2026-04-06 | 2026-04-06 | og-image 1200x630, apple-touch-icon, favicon PNG 4종, manifest.json |
| P-042 | GA4 연동 + 책 QR 유입 추적(UTM) | [x] | 2026-09-03 | 2026-09-03 | SPA 라우터에서 page_view 직접 전송, 네이버 동적 QR 목적지에 UTM 적용 |
| P-043 | SPLG→SPYM 티커 교체 + 캐시 키 정의 일원화 | [x] | 2026-09-03 | 2026-09-03 | 티커 변경으로 7주간 가격 미갱신. 크론 compare 캐시 무효화 버그도 함께 수정 |
| P-044 | 미등록 ETF 티커 soft 404 차단 + API 색인 차단 헤더 | [x] | 2026-09-05 | 2026-09-05 | ego-browser 전수 디버깅에서 발견. 데이터 없는 티커는 noindex+404, 쌓이면 자동 200 전환 |
